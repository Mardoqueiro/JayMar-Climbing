        ...
        <tbody>
          <tr v-for="product in products" :key="product">
            ...
            <td>
                  ...
                  <div class="modal-content">
                    <div class="modal-header">
                      ...
                      <button
                        ...
                        data-bs-dismiss="modal"
                        aria-label="Close"
                        v-on:click="console.log('modalclosed')"
                      ></button>
                    </div>
                    <div class="modal-body">
                      <div class="admin-input">
                    ...
                    <div class="modal-footer">
                      ...
                      <button type="button" @click.prevent="updatProduct()">
                        Save changes
                      </button>
                    </div>
                  </div>
              ...
              <button v-on:click="console.log('hi')">delete</button>
            </td>
          </tr>
        </tbody>
      </table>
